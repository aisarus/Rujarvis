...
describe('сценарийВхода', () => {
  it('берёт путь и доводы в кавычки', () => {
    ...
    // Пробел в пути — это имя человека из двух слов, случай обычный. Прежняя
    // попытка звала `cmd /k <путь>` и ломалась на нём по правилу cmd о двух
    // кавычках: он снимает первую и последнюю.
